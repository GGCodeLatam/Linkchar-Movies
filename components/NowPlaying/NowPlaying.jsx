...
const NowPlaying = () => {
    ...
    return (
        <div className='m lg:m-2 mr-5 lg:mr-14 '>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
                    {
                        movieItems.map((item, i) => (
                            <div key={i} className="col-span-1">
                                <article className="m-5 shadow-xl rounded-3xl bg-cover bg-center w-auto h-30 lg:h-48 transform duration-500 hover:-translate-y-5 cursor-pointer group" style={{ backgroundImage: `url(${apiConfig.w500Image(item.backdrop_path)})` }}>
                                    <div className="bg-black rounded-3xl bg-opacity-20 w-full h-28 lg:h-48 px-2 lg:px-5 flex flex-wrap flex-row  pt-18  lg:pt-18 hover:bg-opacity-75 transform duration-300">
